        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProjectID = table.Column<int>(type: "integer", nullable: false),
                    UserID = table.Column<string>(type: "text", nullable: false),
                    AssignedAs = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProgressUpdates_AspNetUsers_UserID",
                        column: x => x.UserID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ProgressUpdateUpdateID = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Reactions_ProgressUpdates_ProgressUpdateUpdateID",
                        column: x => x.ProgressUpdateUpdateID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "MilestoneID");
                    table.ForeignKey(
                        name: "FK_Attachments_ProgressUpdates_ProgressUpdateUpdateID",
                        column: x => x.ProgressUpdateUpdateID,
                        principalTable: "ProgressUpdates",
                        principalColumn: "UpdateID");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attachments_ProgressUpdateUpdateID",
                table: "Attachments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reactions_ProgressUpdateUpdateID",
                table: "Reactions",
                column: "ProgressUpdateUpdateID");
